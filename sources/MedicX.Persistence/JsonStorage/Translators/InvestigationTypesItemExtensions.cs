...
namespace DustInTheWind.MedicX.Persistence.JsonStorage.Translators
{
    ...
    {
        public static List<TestItem> Translate(this IEnumerable<Entities.InvestigationItem> investigationTypeItems)
        {
        ...
        public static TestItem Translate(this Entities.InvestigationItem investigationItem)
        {
        ...
        public static List<Entities.InvestigationItem> Translate(this IEnumerable<TestItem> investigationTypeItems)
        {
            return investigationTypeItems?
                .Select(Translate)
                .ToList();
        ...
        public static Entities.InvestigationItem Translate(this TestItem testItem)
        {
            if (testItem == null)
                return null;
